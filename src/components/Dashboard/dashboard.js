    ...
    <div className="list">
      ...
      <div className="item">
        <Card style={styles.card}>
          {/*<CardTitle title="US Labour Hours"/>*/}
          <CardHeader
            title="3P3UYawrVA1yEwvesGdm4V6fQjFYwAhrYcr"
            // subtitle=" "
            avatar={flagUs}
          />
          <CardText>
      ...
      <div className="item">
        <Card style={styles.card}>
          {/*<CardTitle title="US Labour Hours"/>*/}
          <CardHeader
            title="3P92D7UVvePu75SXWg3teETurmxXKDHhwPU"
            // subtitle=" "
            avatar={flagUs}
          />
          <CardText>
      ...
      <div className="item">
        <Card style={styles.card}>
          {/*<CardTitle title="US Labour Hours"/>*/}
          <CardHeader
            title="3PMDd99m9WuXasnVuVCNLhRZHshS96Qpey8"
            // subtitle=" "
            avatar={flagUs}
          />
          <CardText>
